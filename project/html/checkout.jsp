			 ...
			 { 
			   ...
			   <% count++;}%>
				...
				<tr>
				   ...
				   <td><h3><input type="text" name="name" ></h3></td>
				</tr>
				<tr>
				   <td><h3>&nbsp &nbsp &nbsp &nbsp 收件地址:</h3></td>
				   <td><h3><input type="text" name="add" ><font color="red" font size="2">*如點選7-11取貨，請填7-11分店名&nbsp &nbsp &nbsp &nbsp </font></h3></td>
				</tr>
				<tr>
				   <td><h3>&nbsp &nbsp &nbsp &nbsp 電話:</h3></td>
				   <td><h3><input type="text" name="tel" ></h3></td>
				</tr>
				<tr>
				    <td><h3>&nbsp &nbsp &nbsp &nbsp Email:</h3></td>
					<td><h3><input type="email" name="email" ></h3></td>
				</tr>
				<tr>
					<td>
