		 ...
		 if(con.isClosed())
		 ...
		 else
		  {
			 ...
			 else if(rs.next())
			 {
			   ...
			   <form name="user" method="post" action="change_user.jsp">
			   <center><table style="border:5px #46a3ff dotted" cellpadding="10" border='0' align="center">
				...
				<tr>
					<td>&nbsp地址 :&nbsp;</td>
					<td>
					<input type="text" name="register_address" value=<%=rs.getString(4)%>>
					</td>
				</tr>
				<tr>
					<td>&nbsp性別 :&nbsp;</td>
				...
				<tr>
					<td>&nbsp電話 :&nbsp;</td>
					<td>
					<input type="text" name="register_phone" value=<%=rs.getString(6)%>>
					</td>
				</tr>
				<tr>
					<td>&nbsp信箱 :&nbsp;</td>
					<td>
					<input type="text" name="register_email" value=<%=rs.getString(7)%>>
					</td>
				</tr>
				<tr>
